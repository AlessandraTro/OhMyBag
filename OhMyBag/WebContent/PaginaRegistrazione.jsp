            ...
            <article class="card-body mx-auto">
                ...
                <form name="form" id="form" action="RegistrazioneControl" method="post" onsubmit="return validate(this)">
                    ...
                    <div class="form-group-costum">
                        ...
                        <input name="inputNome" class="form-control" placeholder="Nome" type="text" id="nome" required> 
                    ...
                    <div class="form-group-costum">
                        <img class="immagine-reg" src="img/website/calendar-days-solid.svg"> 
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-block">Crea un Account</button>
                    </div>
