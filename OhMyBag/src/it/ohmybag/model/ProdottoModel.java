...
public class ProdottoModel {
	...
	/*
	 * ritorna tutti i prodotti di una determinata marca in una determinata
	 * categoria
	 */
	...
	/*
	 * ritorna tutti i prodotti di un determinato anno di collezione in una
	 * determinata categoria in modo crescente in base al prezzo
	 */
	public synchronized Collection<Prodotto> allYearCollectionProductASC(int categoria, int annocollezione)
			throws SQLException {
		Connection conn = null;
		PreparedStatement statement = null;
	...
	/*
	 * ritorna tutti i prodotti di un determinato anno di collezione in una
	 * determinata categoria in modo decrescente in base al prezzo
	 */
	public synchronized Collection<Prodotto> allYearCollectionProductDESC(int categoria, int annocollezione)
			throws SQLException {
		Connection conn = null;
		PreparedStatement statement = null;
	...
	/*
	 * ritorna il numero di prodotti di una determinata categoria in un determinato
	 * range di prezzo in modo crescente in base al prezzo
	 */
	public synchronized Collection<Prodotto> allRangePriceProductASC(int categoria, float min, float max)
			throws SQLException {
		Connection conn = null;
		PreparedStatement statement = null;
	...
	/*
	 * ritorna il numero di prodotti di una determinata categoria in un determinato
	 * range di prezzo in modo decrescente in base al prezzo
	 */
	public synchronized Collection<Prodotto> allRangePriceProductDESC(int categoria, float min, float max)
			throws SQLException {
		Connection conn = null;
		PreparedStatement statement = null;
